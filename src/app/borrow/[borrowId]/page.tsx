  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `https://dlms-backend.onrender.com/borrow/${userId}`,
        {
          method: "POST",
          headers: {
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex flex-col items-center sm:flex-row sm:items-start sm:space-x-6 mt-14">
        ...
        <div className="mt-6 sm:mt-0 sm:w-1/2 w-full text-center sm:text-left">
          <h2 className="font-sans text-2xl font-semibold text-blue-900 p-2">
            You are borrowing:
          </h2>
          ...
          <form
            ...
            className="flex flex-col gap-4 pt-8 text-black"
          >
