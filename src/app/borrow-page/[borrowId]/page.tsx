    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="flex flex-col items-center">
                <h2 className="font-sans text-2xl font-semibold text-blue-900 md:absolute top-[180px]">You are borrowing:</h2>
                <h3 className="text-xl font-semibold md:absolute top-[220px]">{borrow.title}</h3>

                <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 mt-4 w-full max-w-md">
